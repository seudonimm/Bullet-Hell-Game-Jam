...
public static class PlayerEnemyStats
{
    ...
    private static int playerAtkDmg;      //2
    ...
    public static int PlayerAtkDmg { get => playerAtkDmg; set => playerAtkDmg = value; }
    ...
    public static int EnemyHealth { get => enemyHealth; set => enemyHealth = value; }
}